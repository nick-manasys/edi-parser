...
public class StandardD03aTest extends EdifactTestBase {
    ...
    public void verifyCOPARN() throws Exception {
        ...
        assertEquals("UNB+UNOA:3+1STOP+MSK+XXXXXXXXXXX+'UNH++CONTRL:D:03A:UN'UCI+1853296+MSK+1STOP+7'UNT+3+1'UNZ+1+1'",
    ...
    public void verifyIFTMCS() throws Exception {
        ...
        assertEquals("UNB+UNOA:3+1STOP+APL+XXXXXXXXXXX+'UNH++CONTRL:D:03A:UN'UCI+160315143316+APL+1STOP+7'UNT+3+1'UNZ+1+1'",
