...
public class StandardD96aTest extends EdifactTestBase {
    ...
    public void verifyGeneratedORDERSAcks() {
        ...
        assertEquals("UNB+UNOA:3+MODUS:ZZZ+MULESOFT:ZZZ+XXXXXXXXXXX+++ORDERS'UNH++CONTRL:D:96A:UN'UCI+582+MULESOFT:ZZZ+MODUS:ZZZ+7'UCM+6424+ORDERS:D:96A:UN:EAN008+4'UCS+4+35'UNT+5+1'UNZ+1+1'",
            stripAckDates(parseAndReturnAck("/edifact/d96a/ORDERS_D96A_duplicate-BGM.edi")));
        assertEquals("UNA:+.?*'UNB+UNOA:3+MODUS:ZZZ+XXXXXXXXXXXX++1++ORDERS'UNH++CONTRL:D:96A:UN'UCI+14+MULESOFT:ZZZ+MODUS:ZZZ+7'UCM+1+ORDERS:D:96A:UN:EAN008+4'UCS+3'UCD+13+1'UCS+4'UCD+13+1'UNT+8+1'UNZ+1+1'",
        ...
        assertEquals("UNB+UNOA:3+MODUS:ZZZ+MULESOFT:ZZZ+XXXXXXXXXXX+++ORDERS'UNH++CONTRL:D:96A:UN'UCI+582+MULESOFT:ZZZ+MODUS:ZZZ+7'UCM+6424+ORDERS:D:96A:UN:EAN008+4'UCS+4+35'UCS+10+35'UNT+6+1'UNZ+1+1'",
