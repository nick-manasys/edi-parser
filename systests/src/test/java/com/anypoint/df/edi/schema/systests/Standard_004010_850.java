...
public class Standard_004010_850 extends X12TestBase {
    ...
    public void verifyGeneratedAcks() {
        ...
        assertEquals("ISA*00*          *00*          *ZZ*BECKER         *12*ZZ             *XXXXXX*XXXX*U*00401*XXXXXXXXX*X*P*>~GS*FA*QSTEST*BECKER*XXXXXXXX*XXXX**X*004010~ST*997*0001~AK1*PO*210000004~AK9*R*1*1*0*2~SE*4*0001~GE*1*1~IEA*1*000000001~",
        ...
        assertEquals("ISA*00*          *00*          *14*185122629OMX   *ZZ*14             *XXXXXX*XXXX*U*00401*XXXXXXXXX*X*P*>~GS*FA*9256*185122629OMX*XXXXXXXX*XXXX**X*004010~ST*997*0001~AK1*PO*11~AK9*R*3*3*0*2~SE*4*0001~GE*1*1~IEA*1*000000001~",
