...
public class Standard_005010_850 extends X12TestBase {
    ...
    public void verifyGeneratedAcks() {
        assertEquals("ISA*00*          *00*          *ZZ*MODUS          *ZZ*ZZ             *XXXXXX*XXXX*U*00501*XXXXXXXXX*X*P*>~GS*FA*MULESOFT*MODUS*XXXXXXXX*XXXX**T*00501~ST*997*0001~AK1*PO*4*00501~AK9*A*1*1*1~SE*4*0001~GE*1*1~IEA*1*000000001~",
