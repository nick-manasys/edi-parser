...
public class BiztalkTest extends X12TestBase {
    ...
    public void verifyGeneratedAcks() {
        ...
        assertEquals("ISA*00*          *00*          *ZZ*MODUS          *ZZ*ZZ             *XXXXXX*XXXX*U*00501*XXXXXXXXX*X*P*>~GS*FA*MULESOFT*MODUS*XXXXXXXX*XXXX**X*005010~ST*997*0001~AK1*PO*223456789*005010~AK2*850*000000123~AK3*CUR*3**2~AK3*REF*4**2~AK5*R*5~AK9*R*1*1*0~SE*8*0001~GE*1*1~IEA*1*000000001~",
